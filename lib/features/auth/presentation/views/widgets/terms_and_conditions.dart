...
import 'package:lastfruitapp/features/auth/presentation/views/widgets/custom_check_box.dart';
...
class _TermsAndConditionsState extends State<TermsAndConditions> {
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        CustomCheckBox(isChecked: isTermsAccepted, onChecked: (bool value) { isTermsAccepted=value;
          setState(() {
        ...
        Expanded(
          child: Text.rich(TextSpan(children: [
            ...
            TextSpan(text: 'بنا',style: TextStyles.semiBold13.copyWith(color: AppColors.lightPrimaryColor))
